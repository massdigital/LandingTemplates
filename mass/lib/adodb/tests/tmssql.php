...
function tpear()
{
include_once('../../../../../fda/inst/adodb/tests/DB.php');
...
function tadodb()
{
include_once('../../../../../ajax/lib/adodb/adodb.inc.php');
...
?>
<a href=../../../../../ajax/lib/adodb/tests/tmssql.php?do=tmssql>mssql</a>
<a href=../../../../../ajax/lib/adodb/tests/tmssql.php?do=tpear>pear</a>
<a href=../../../../../ajax/lib/adodb/tests/tmssql.php?do=tadodb>adodb</a>
<?php
if (!empty($_GET['do'])) {
	$do = $_GET['do'];
	switch($do) {
