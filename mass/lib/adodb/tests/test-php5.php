...
include("../../../../../fda/inst/adodb/tests/adodb-exceptions.inc.php");
include("../../../../../fda/inst/adodb/tests/adodb.inc.php");	
...
try {
	include_once("../../../../../ajax/lib/adodb/adodb-active-record.inc.php");
...
include_once("../../../../../ajax/lib/adodb/tests/test-active-record.php");
?>