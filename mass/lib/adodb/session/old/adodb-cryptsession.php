...
wrapper library.
 ...
 =======
	...
	include('../../../../../../fda/inst/adodb/session/old/adodb.inc.php');
	#---------------------------------#
	include('../../../../../../ajax/lib/adodb/session/old/adodb-cryptsession.php'); 
	#---------------------------------#
	session_start();
...
include_once('../../../../../../ajax/lib/adodb/session/old/crypt.inc.php');
